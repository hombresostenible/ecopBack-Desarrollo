...
//EMAIL DE CONFIRMACION DE REAGENDAMIENTO DE CITA DE COMPANY
export const mailUpdateAppointmentCompany = (email: string, nameCompany: string, newDate: Date, newHour: string) => {
    return {
        from: `Ecopción <${EMAIL}>`,
        to: email,
        subject: 'Actualización de tu cita',
            ...
            <div style="background: #e9ecef; width: 100%; min-height: 900px;">
                <div style="background: #ffffff; margin: auto; width: 700px; height: 100%">
                    <div style="width: 100%; min-height: 670px;">
                        ...
                        <p style="margin: 20px 40px; font-size: 16px;">¡Hola ${nameCompany},</p>
                        <p style="margin: 20px 40px; font-size: 16px;">¡Tu cita ha sido actualizada!</p>
                        <br/>
                        <p style="margin: 20px 40px; font-size: 16px;"><b>Fecha y hora actualizadas:</b></p>
                        <p style="margin: 20px 40px; font-size: 16px;"><b>Fecha:</b> ${newDate}</p>
...
//EMAIL DE CANCELACION DE CITA DE COMPANY
export const mailCancelAppointmentCompany = (email: string, nameCompany: string, canceledDate: Date, canceledHour: string) => {
    return {
        from: `Ecopción <${EMAIL}>`,
        to: email,
        subject: 'Cancelación de tu cita',
