...
import {
    ...
    deleteAssetService,
} from '../../../../services/UserPanel/03Inventories/01InventoryAssets/assets.service';
import { authRequired } from "../../../../middlewares/Token/Token.middleware";
import { validateSchema } from "../../../../middlewares/Schema/Schema.middleware";
import { checkRole, checkRoleArray } from '../../../../middlewares/User/Role.middleware';
import { assetsSchemaZod, manyAssetsSchemaZod } from '../../../../validations/UserPanel/assets.zod';
...
router.post("/create-many", authRequired, checkRoleArray, validateSchema(manyAssetsSchemaZod), async (req: Request, res: Response) => {
    try {
        ...
        const serviceLayerResponse = await postManyAssetService(userId, typeRole, bodyArray);
