...
} from '../../../services/UserPanel/04Accounts/accountsBook.service';
import { authRequired } from "../../../middlewares/Token/Token.middleware";
import { validateSchema } from "../../../middlewares/Schema/Schema.middleware";
import { checkRole } from '../../../middlewares/User/Role.middleware';
import { accountsBookSchemaZod } from '../../../validations/UserPanel/accountsBook.zod';
...
router.delete('/:idAccountsBook', authRequired, checkRole, async (req: Request, res: Response) => {
    try {
        ...
        console.log('idAccountsBook: ', idAccountsBook)
