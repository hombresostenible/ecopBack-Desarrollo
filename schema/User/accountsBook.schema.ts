...
class AccountsBook extends Model {
    ...
    public creditCash!: 'Contado' | 'Crédito';
    ...
    public incomeCategory!: 'Producto' | 'Materia Prima' | 'Mercancía' | 'Servicio' | 'Activo' | 'Crédito del banco' | 'Crédito en Cooperativa' | 'Gota gota' | 'Crédito de almacén' | 'Crédito de servicios públicos';
...
AccountsBook.init(
    {
        ...
        incomeCategory: {
            ...
            allowNull: true,
            validate: {
                isIn: [[ 'Producto', 'Materia Prima', 'Mercancía', 'Servicio', 'Activo', 'Crédito del banco', 'Crédito en Cooperativa', 'Gota gota', 'Crédito de almacén', 'Crédito de servicios públicos' ]],
            },
        },
        nameItem: {
            type: DataTypes.STRING,
...
AccountsBook.belongsTo(Company, {
