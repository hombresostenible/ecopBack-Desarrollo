...
AccountsPayable.belongsTo(AccountsBook, {
    foreignKey: 'accountsBookId',
    as: 'accountsBook',
});

AccountsPayable.belongsTo(Assets, {
    foreignKey: 'assetId',
    as: 'assets',
});

AccountsPayable.belongsTo(Merchandise, {
    foreignKey: 'merchandiseId',
    as: 'merchandise',
});

AccountsPayable.belongsTo(Product, {
    foreignKey: 'productId',
    as: 'product',
});

AccountsPayable.belongsTo(RawMaterial, {
    foreignKey: 'rawMaterialId',
    as: 'rawMaterial',
});

AccountsPayable.belongsTo(Service, {
    foreignKey: 'serviceId',
    as: 'service',
});

AccountsPayable.belongsTo(Branch, {
    foreignKey: 'branchId',
    as: 'branch',
});
